...
let FeedingModule = exports.FeedingModule = class FeedingModule {
};
exports.FeedingModule = FeedingModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: feeding_schema_1.Feeding.name, schema: feeding_schema_1.FeedingSchema }]),
        ],
